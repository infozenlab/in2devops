...
/**
 * Proxy service implementation class to communicate with <b>FDA Open data set</b>
 * <b>RESTFul</b> service
 *
...
public interface FDADataProxyService {
	 ...
	 *
	 * @param partialDrugName the partial drug name
	 * @return Collection Drugs names with sort order A-Z
	 */
	public List<String> getDrugNames(String partialDrugName);
	
	/**
	 * Get summary of <b>Adverse Drug Events</b> reported with the given criteria specified
	 * in the request {@link GetDrugAdverseSummaryRequest} object.
	 * 	
